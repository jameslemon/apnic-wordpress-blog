...
?>
    <div class="col-md-4" id="hero-title">
        <h1 title="<?php the_title_attribute();?>"><a href="<?php the_permalink(); ?>" id="thumbnail-link-co-hover-hero-<?php echo get_the_ID(); ?>"><?php the_title(); ?></a></h1>
        ...
        <?php 
            ...
            if(has_excerpt()){
                $my_awesome_excerpt = get_the_excerpt(); 
            }
    ...
    <div class="col-md-8" id="hero-desc"><?php if ( has_post_thumbnail() ) { ?><a href="<?php the_permalink(); ?>" class="thumbnail-link-co-hover" data-target="#thumbnail-link-co-hover-hero-<?php echo get_the_ID(); ?>"><?php the_post_thumbnail('featuredImageLarge'); ?></a><?php } ?>
        <p class="ellipsis" data-ellipsis-rows="3">
            <?php echo $my_awesome_excerpt; ?>
        </p>
</div>
<?php 
    endwhile;
